...
- A simple microgrid model (solar input → battery → loads) with configurable scenarios
- Simulation outputs for validating behavior (e.g., SoC trends, charge/discharge, load-shedding events)
